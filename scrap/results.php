<?php
  ...
  function loan_calc($loan_amount, $loan_length, $interest_rate) {
    ...
    //rounding the loan rate 
    //$payment = number_format($payment, 2);
    return $payment;
  }

  //Calculating the interest
  // function interest_calc($loan_amount, $loan_length, $interest_rate) {

  //   $interest = $loan_amount * $loan_length  * $interest_rate;
  //   return $interest;
  // }
  ...
  echo 'Loan Length: ' . $loan_length . '<br>';
  echo 'Loan Amount: ' . $loan_amount . '<br>';
  echo 'Monthly Payments:' . ' ' . $payment . '<br>';
...
<body>
    ...
    <main>
        ...
        <div>
          <p>The amount of your loan was: <?php echo $loan_amount ?>, over <?php echo $loan_length ?></p>
        </div>
