...
$lifetime = 60 * 60 * 24 * 365 * 3; // cookie last for 3 years. 
...
switch($action) {
    ...
    case 'empty_cart':
        ...
        break;
    case 'end_session':
        $_session = array(); //Clear Session data from memory p.365
        session_destroy(); //Clean up the session ID. P365

        //Deleting cookie session. P 365 code
        $name = session_name();
